...
# ===== TECHNOLOGY TRENDS TOPIC =====
tech_queries = [
    "EV battery technology types LFP NMC explained India",
    "what to check before buying EV battery motor range technology",
    "EV charging technology types AC DC fast charging explained",
    "EV motor types BLDC PMSM technology comparison",
    "EV technology trends India 2026 what matters buyers"
]

result = collect_domain_knowledge("Battery and Technology", tech_queries)